...
window.onload = function init()
{
    ...
    sclLoc = gl.getUniformLocation(program, "scl");

    axisScl = xAxis;
    var val = document.getElementById( "slide4" ).value;
    sclInput = val;
    ...
    document.getElementById( "slide1" ).oninput = function(){
        axisTr = xAxis;
        var val = document.getElementById( "slide1" ).value;
        trInput = val;
    };

    document.getElementById( "slide2" ).oninput = function(){
        axisTr = yAxis;
        var val = document.getElementById( "slide2" ).value;
        trInput = val;
    };

    document.getElementById( "slide3" ).oninput= function(){
        axisTr = zAxis;
        var val = document.getElementById( "slide3" ).value;
        trInput = val;
   };
   ...
   document.getElementById( "slide4" ).oninput = function(){
    ...
    document.getElementById( "slide5" ).oninput = function(){
        axisScl = yAxis;
        var val = document.getElementById( "slide5" ).value;
        sclInput = val;
    };

    document.getElementById( "slide6" ).oninput= function(){
        axisScl = zAxis;
        var val = document.getElementById( "slide6" ).value;
        sclInput = val;
    };
    render();
}
...
function render()
{
    ...
    {
        theta[axis] += degree;
        scl[axisScl] = sclInput;
        tr[axisTr] = trInput;
        gl.uniform3fv(thetaLoc, theta);
        gl.uniform3fv(sclLoc, scl);
